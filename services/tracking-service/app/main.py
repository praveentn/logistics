"""Tracking Service - Main FastAPI application."""
...
async def lifespan(app: FastAPI):
    ...
    """
    # Startup
    logger.info("tracking_service_starting")
    ...
    try:
        ...
        logger.info("messaging_publisher_initialized")

        # Start consumer in background
        asyncio.create_task(start_consumer())
        logger.info("messaging_consumer_started")
    ...
    # Shutdown
    logger.info("tracking_service_shutting_down")
    service_up.set(0)
...
app = FastAPI(
    ...
    description="Handles shipment tracking for the logistics platform",
    version="1.0.0",
    lifespan=lifespan
)
...
async def health_check():
    ...
    messaging_status = publisher.get_status()
...
async def readiness_check():
    ...
    Returns:
        Readiness status
    """
    return {"status": "ready", "service": "tracking-service"}
